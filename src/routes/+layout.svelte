<script lang="ts">
	...
	const CLARITY_PROJECT_ID = 'wc3od2u2w4';
...
<svelte:head>
	...
	<meta
		name="description"
		content="A SvelteKit interaction lab designed to generate meaningful Microsoft Clarity behavioral analytics — rage clicks, dead clicks, quick backs, and scroll heatmaps."
	/>
	<link rel="preconnect" href="https://fonts.googleapis.com" />
	<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin="anonymous" />
	<link
		href="https://fonts.googleapis.com/css2?family=JetBrains+Mono:wght@400;700&family=Inter:wght@300;400;500;600;700;800&display=swap"
		rel="stylesheet"
	/>
</svelte:head>
...
<footer class="lab-footer">
	<p>
		All interactions on this page are recorded by <strong>Microsoft Clarity</strong>. Data appears
		in the Clarity dashboard within minutes.
	</p>
	<p class="footer-links">
		<a href="https://clarity.microsoft.com" target="_blank" rel="noopener noreferrer"
			>Open Clarity Dashboard ↗</a
		>
		&nbsp;·&nbsp;
